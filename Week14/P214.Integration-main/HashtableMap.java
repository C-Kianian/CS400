...
public class HashtableMap<KeyType, ValueType> implements MapADT {
  ...
  public void test1() {
    HashtableMap<String, Integer> map =
        new HashtableMap<>();//create maps with different constructors
    HashtableMap<String, Integer> mapInitCap = new HashtableMap<>(5);
  ...
  @Test
  public void test2() {
    HashtableMap<String, Integer> map = new HashtableMap<>(100);//make a map
  ...
  @Test
  public void test5() {
    HashtableMap<String, Integer> map = new HashtableMap<>(5);//make a map
